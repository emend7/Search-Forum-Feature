...
INSERT INTO Posts (Review_ID, Product_ID, Title, Description, Read_Time, Num_Upvotes, Num_Downvotes, Approved, Industry, Is_Resolved, Solution)
    VALUES(1, '70161', 'Recommendation For Lubricant For Heavy Load Machinery? ', 'Customer is looking for a bearing grease suitable for heavly-load machinery being assembled on conveyors in manufacturing enviorments.',
    ...
    (2, '2OLA83', 'Lubricant for Construction?', 'Customer is a manager on a construction team looking for a lubricant that can work on multiple tools and machines.',
